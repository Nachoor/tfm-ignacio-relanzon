...
\textbf{Aplicación web} (\texttt{app/datanex\_clean2/}). Contiene el código de la
interfaz \texttt{Streamlit}: \texttt{datanex\_app.py} (módulo principal),
...
\textbf{Validación} (\texttt{04\_validacion/}). Scripts de validación cuantitativa sobre
