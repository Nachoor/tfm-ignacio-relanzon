...
Uso rÃ¡pido (lanzar desde C:\\Users\\Nacho\\Documents\\TFM):
    python actualizar_ofertas.py

Solo scraping sin subir:
    python actualizar_ofertas.py --no-upload

Solo USA o solo EspaÃ±a:
    python actualizar_ofertas.py --locations Spain
    python actualizar_ofertas.py --locations "United States"

MÃ¡s resultados / mÃ¡s recientes:
    python actualizar_ofertas.py --results 300 --hours-old 72
"""
